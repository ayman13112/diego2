...
const CorpRegisteredCourse2 = () => {
  ...
  const handleRateSubmit = async (e) => {
    ...
    await axios
      .put(`/api/corporateTrainee/setcourcerate/${id2}`, {
        Rating: rating,
      })
      .then((res) => {
        console.log(res);
  ...
  const handleInstructorRateSubmit = async (e) => {
    ...
    await axios
      .put(`/api/corporateTrainee/setrate/${course?.instructor}`, {
  ...
  return (
    <article>
      <div>
        ...
        <br />
      <button onClick={()=>window.location.href=`/CorpWriteNotes/${id1}/${id2}`}>Write Notes</button>
...
export default CorpRegisteredCourse2;
